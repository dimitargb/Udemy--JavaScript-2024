...
// Let's do some more examples of Reduce method. this time we want to get the maximum value of the movements array.
...
// Here we start with the first movement ->  movements[0] and compare the rest of the array Elements
console.log(maxValue); // 3000

const minValue = movements.reduce((acc, value) => {
  if (acc < value) {
    return acc;
  } else {
    return value;
