...
console.log(orerdsSet.size); // 3 Calculating the size.
...
//Sets are iterables and therefor we can loop over them:
...
const staffUniqueArray = [...new Set(staff)]; // the Spread Operator takes all the Elements out of the itrable.
console.log(staffUniqueArray); //  ['Waiter', 'Chef', 'Manager'];

// If we want to knw=ow how many unique Positions there are we use:
console.log(
  new Set(['Waiter', 'Chef', 'Waiter', 'Manager', 'Chef', 'Waiter']).size
); // 3

// If we want to  know how many diffrent letters they are in a string:
console.log(new Set('dimitardamianov').size); // 9
